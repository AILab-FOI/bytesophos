...
// removes <think>...</think> blocks and stray <think> tags from markdown
...
// assisted with chatgpt5
// converts single-line fenced code blocks into inline code
...
// assisted with chatgpt5
// escapes < and > outside code, converts autolinks <url> to Markdown links, and strips <think> tags
...
// assisted with chatgpt5
// create a typing effect (text is revealed character-by-character as it arrives from LLM's response)
...
// assisted with chatgpt5
// heuristically detects short identifier-like strings for inline code rendering
...
// assisted with chatgpt5
// renders paragraphs, if a paragraph is only inline code, display it as styled inline code
